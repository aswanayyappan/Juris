            ...
            <div className="w-full max-w-lg">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* CIN Number */}
                  <div>
                    <label className="text-sm font-medium text-slate-300 block mb-1.5">Corporate Identification Number ( CIN )</label>
                    <input
                      type="text"
        ...
        <div className="px-6 py-5 flex-shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">{business.type} · {business.state} · CIN: {business.employeeCount}</p>
            </div>
            <button
